...
public class AcaoAtacar implements AcaoInimigo{
    ...
    public String executar(Inimigo dono, Heroi alvo) {
        ...
        /*Isso aqui não resolve a questão de imprimir certo quando usa fraqueza  [CORRECAO]*/ 
        return dono.getNome() + " usou '" + this.nomeAcao + "' e causou " + Cores.VERMELHO + this.valorDano + " de Dano" + Cores.RESET + " de dano no " + alvo.getNome() + "!";
    }
