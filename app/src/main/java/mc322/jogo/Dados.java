...
public class Dados {
    ...
    public static ArrayList<Heroi> carregarHerois() {
        ...
        deckShrek.adicionaBaralho(
                new CartaDano("Soco do Ogro", "Dano: [Custo: 3 | Dano: 30] - Um jab de direita.", 3, 30));
        deckShrek.adicionaBaralho(
                new CartaDano("Pântano tenebroso", "Dano: [Custo: 5 | Dano: 50] - É como o nome diz.. ", 5, 40));
        ...
        deckShrek.adicionaBaralho(
                new CartaEscudo("Panela de Lama", "Escudo: [Custo: 1 | Escudo: 5] - Sabor escudo.", 1, 5));

        deckShrek.adicionaBaralho(new CartaEfeito("Hálito Matinal de Ogro",
                "Efeito: [Custo: 3 | Turnos: 2 |Veneno] - Depois de escovar os dentes", 3, (new EfeitoVeneno(2, gm))));
        ...
        deckShrek.adicionaBaralho(new CartaEfeito("Banho de Lama",
                "Efeito: [Custo: 2 | Turnos: 5 |Força: +50%] - Renovado.", 2, (new EfeitoForca(5, gm, 50))));
        ...
        deckBurro.adicionaBaralho(
                new CartaDano("Coice do Burro", "Dano: [Custo: 1 | Dano: 10] - Um coice rápido e inesperado.", 1, 10));
        ...
        deckBurro.adicionaBaralho(
                new CartaEscudo("Botas Velhas", "Escudo: [Custo: 1 | Escudo: 10] - Defesa simples, mas útil.", 1, 10));

        deckShrek.adicionaBaralho(new CartaEfeito("A gente já chegou?",
                "Efeito: [Custo: 4 | Turnos: 8 | Veneno] - A gente já chegou?", 4, (new EfeitoVeneno(8, gm))));
        ...
        deckGato.adicionaBaralho(
                new CartaDano("Corte Preciso", "Dano: [Custo: 2 | Dano: 20] - Um ataque rápido e certeiro.", 2, 20));
        ...
        deckGato.adicionaBaralho(new CartaEfeito("7 vidas",
                "Efeito: [Custo: 4 | Turnos: 7| Força: +30%] - Até a Morte teme", 4, (new EfeitoForca(7, gm, 30))));
        deckGato.adicionaBaralho(new CartaEfeito("Marca do Caçador",
                "Efeito: [Custo: 2 | Turnos: 4 |Fraqueza: 30%] - Identifica o ponto fraco do inimigo.", 2,
        ...
        deckFiona.adicionaBaralho(
                new CartaDano("Golpe de Princesa", "Dano: [Custo: 3 | Dano: 26] - Elegância com força.", 3, 26));
        deckFiona.adicionaBaralho(
                new CartaDano("Fúria de Ogra", "Dano: [Custo: 1 | Dano: 14] - Mostra sua verdadeira força.", 1, 14));
        deckFiona.adicionaBaralho(
                new CartaDano("Combo Real", "Dano: [Custo: 4 | Dano: 42] - Sequência poderosa de ataques.", 4, 42));
        ...
        deckFiona.adicionaBaralho(new CartaEfeito("Pressão Real",
                "Efeito: [Custo: 3 | Turnos: 4| Fraqueza: 20%] - Sente a pressão", 3, (new EfeitoFraqueza(4, gm, 20))));
