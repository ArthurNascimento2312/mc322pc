...
public class Musica {
  ...
  public void tocarMusica(String nomeArquivo) {
        ...
        try {
            ...
            // PLANO B: Se não achou na raiz, assume que o Java rodou dentro da pasta 'src' ou 'bin' e volta uma pasta (../)
            ...
            if (arquivoMusica.exists()) {
                ...
                System.out.println(Prints.VERMELHO + "🎵 [Aviso] Arquivo não encontrado em nenhum diretório: " + nomeArquivo + Prints.RESET);
            }
